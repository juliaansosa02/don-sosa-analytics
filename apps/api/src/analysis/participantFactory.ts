import { calculateScore, type ParticipantSnapshot, type RuneSelection } from '@don-sosa/core';
...
export function createParticipantSnapshot(match: RiotMatch, timeline: RiotTimeline, participant: RiotParticipant, runeIndex: Map<number, RuneNode>): ParticipantSnapshot {
  ...
  const timelineStats = analyzeTimeline(participant, match.info.participants, timeline, laneOpponent);
