...
function buildMatchupNarrative(matchup, baseline, locale) {
...
function MetricBlock({ label, value, info, trend }) {
    return (_jsxs("div", { style: metricBlockStyle, children: [_jsxs("div", { style: { ...metricLabelStyle, display: 'flex', alignItems: 'center' }, children: [label, _jsx(InfoHint, { text: info })] }), _jsx("div", { style: metricValueStyle, children: value }), trend ? _jsx(TrendIndicator, { direction: trend.direction, tone: trend.tone }) : null] }));
}
