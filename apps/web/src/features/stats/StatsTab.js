...
import { buildMatchQuickRead, findAnchorChampion, findReferenceMatch, findReviewPriorityMatch, getChampionAccent } from '../dashboard/dashboardSignals';
...
export function StatsTab({ dataset, locale = 'es' }) {
    ...
    return (_jsxs("div", { style: { display: 'grid', gap: 16 }, children: [_jsxs("section", { style: {
                    display: 'grid',
                    gap: 14,
                    padding: 18,
                    borderRadius: 22,
