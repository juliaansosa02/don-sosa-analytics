...
export function CoachingHome({ dataset, locale = 'es', aiCoach, generatingAICoach = false, aiCoachError, onGenerateAICoach, onSendFeedback, roleReferences = [], roleReferencesLoading = false, roleReferencesError = null }) {
...
const tileStyle = { display: 'grid', gap: 8, padding: '15px 16px', borderRadius: 16, minHeight: 128, alignContent: 'start', background: 'linear-gradient(180deg, rgba(11, 15, 24, 0.98), rgba(7, 10, 16, 0.98))', border: '1px solid rgba(255,255,255,0.05)' };
...
const reviewCardStyle = { display: 'grid', gap: 12, padding: '16px 16px', borderRadius: 18, background: 'linear-gradient(180deg, rgba(10, 15, 24, 0.98), rgba(7, 11, 17, 0.98))', border: '1px solid rgba(255,255,255,0.05)', alignContent: 'start', height: '100%' };
