import { championIntelligenceCatalog } from '../../../../../packages/core/src/championIntelligence';
...
function matchupSummary(matches) {
...
function buildRecentTrendLabel(matches, locale) {
...
function buildPlayerFit(matches, profile, locale) {
...
function fallbackProfile(championName, role, locale) {
    return {
        championName,
        role,
...
export function buildChampionIntelligenceWorkbench(dataset, locale = 'es') {
