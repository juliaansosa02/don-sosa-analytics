...
export default function App() {
    ...
    const coachRequestKey = useMemo(() => {
        if (!viewDataset || !gameName || !tagLine)
            return null;
        return [
    ...
    const renderedTab = useMemo(() => {
        ...
        switch (activeTab) {
            case 'coach':
                return (_jsx(CoachingHome, { dataset: viewDataset, locale: locale, aiCoach: aiCoach, generatingAICoach: aiCoachLoading, aiCoachError: aiCoachError, onGenerateAICoach: () => void handleGenerateAICoach(true), onSendFeedback: (verdict) => void handleAICoachFeedback(verdict) }));
            case 'stats':
