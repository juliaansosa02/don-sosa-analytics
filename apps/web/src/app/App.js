...
function getSavedProfileReadinessLabel(profile, locale) {
    ...
    if (completion >= 1)
        return locale === 'en' ? 'Baseline ready' : 'Base lista';
    if (completion >= 0.75)
        return locale === 'en' ? 'Almost complete' : 'Casi completa';
    if (completion >= 0.45)
